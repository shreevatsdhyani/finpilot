...
def generate_recommendation(
    ...
    rec = compute_recommendations(avg_income, avg_expense, risk_profile=risk_profile)
    doc = {
        "user_id": user_id,
        "safe_to_invest": rec["safe_to_invest"],
        "risk_profile": rec["risk_profile"],
        "buckets": rec["buckets"],
        "inputs_snapshot": rec["inputs_snapshot"],
    ...
    # audit
    write_audit(db, user_id, "recommendation_generate", "Generated investment recommendations", f"safe_to_invest={rec['safe_to_invest']}, profile={rec['risk_profile']}")
